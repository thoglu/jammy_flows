...
This package implements (conditional) PDFs with **J**oint **A**utoregressive **M**anifold (**MY**) normalizing-flows. It grew out of work for the paper [Unifying supervised learning and VAEs - coverage, systematics and goodness-of-fit in normalizing-flow based neural network models for astro-particle reconstructions [arXiv:2008.05825]](https://arxiv.org/abs/2008.05825). Several other state-of-the art flows are implemented sometimes using slight modifications or extensions.

- For Euclidean manifolds, it includes an updated implementation of the [offical implementation](https://github.com/chenlin9/Gaussianization_Flows) of [Gaussianization flows [arXiv:2003.01941]](https://arxiv.org/abs/2003.01941), where now the inverse is differentiable (adding Newton iterations to the bisection) and made more stable using better approximations of the inverse Gaussian CDF. 

- Neural spline flows can be modified to have smoothness constraints (as decribed in [arXiv:2604.19846](https://arxiv.org/abs/2604.19846)), which allows them to behave numerically more stable in conditional settings.
...
- [x] Autoregressive simplex flow (experimental) [arXiv:2008.05456](https://arxiv.org/abs/2008.05456) (**"w"**)
